class ZipCodesController < InheritedResources::Base
  ...
  def create
    ...
    respond_to do |format|
      if @zip_code.save
        format.html { redirect_to @zip_code, notice: 'ZipCode was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @zip_code.update(zip_code_params)
        format.html { redirect_to @zip_code, notice: 'ZipCode was successfully updated.' }
  ...
  def destroy
    @zip_code.destroy
    respond_to do |format|
      format.html { redirect_to zip_codes_url, notice: 'ZipCode was successfully destroyed.' }
  ...
  # Never trust parameters from the scary internet, only allow the white list through.
    def zip_code_params
      params.require(:zip_code).permit(:name, :latitude, :longitude, :region_id)
    end
end
